...
config/claude-permission-mode  optional one-token permission posture for every Claude worker launch: absent or "auto" launches with --permission-mode auto, "bypass" keeps --dangerously-skip-permissions; LOCAL, gitignored; inherited by secondmate homes; see docs/configuration.md "Claude permission mode"
